...
const Header = () => {
  ...
  return (
    <div className="container z-50 fixed top-0 mx-auto px-4 flex items-center justify-between bg-[#29292b] text-white text-[14px] border-b border-b-[#434345]">
      ...
      <div className="flex gap-16 items-center w-[65%] z-10 justify-center relative">
        <ul className="flex gap-20 items-center justify-center">
          ...
          >
            ...
            <div
              className={`dropdownMenu flex flex-col gap-16 items-center justify-start ${
                isModalOpen.modal1 ? "open" : "closed"
              }`}
              onMouseEnter={() => handleMouseEnter("modal1")}
              onMouseLeave={() => handleMouseLeave("modal1")}
            >
          ...
          >
            ...
            <div
              className={`dropdownMenuAlt flex flex-col gap-16 items-center justify-start ${
                isModalOpen.modal2 ? "open" : "closed"
              }`}
              onMouseEnter={() => handleMouseEnter("modal2")}
              onMouseLeave={() => handleMouseLeave("modal2")}
            >
